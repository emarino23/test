    ...
    return Obx(() {
      return Padding(
        padding: EdgeInsets.only(
          top: Get.height * (visible.value ? 0.2 : 0.35),
          left: Get.width * 0.46,
        ),
        child: SizedBox(
          child: Wrap(children: [
              ...
              children: [
                ...
                if (customerStates.value.isNotEmpty)
                  CustomFormDropDownFieldWidget(
                    ...
                    value: getFormValue(
                        globalctx.memory, "customer", "state_id", "0"),
                    hintText: "State",
                    onChanged: (value) {
                      ctrl!.state.state = value!;
                      getCities(ctrl);
                      setFormValue(
                          globalctx.memory, "customer", "state_id", value);
                    },
                    onSaved: (value) {
                      ctrl!.state.state = value!;
                      getCities(ctrl);
...
class CustomerKeyPad extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(top: Get.height * 0.65, left: Get.width * 0.6),
      child: TextButton(
        onPressed: () {
...
class BasicInformation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return Padding(
        padding: EdgeInsets.only(
          top: Get.height * (!visible.value ? 0.35 : 0.2),
...
class TourInformation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return Padding(
        padding: EdgeInsets.only(
          top: Get.height * (!visible.value ? 0.62 : 0.4),
          left: Get.width * 0.035,
        ),
        child: Wrap(
          children: [
