              ...
              child: SingleChildScrollView(
                child: Column(children: [
                  ...
                  BudgetField(
                      ...
                      accomodationType: accomodationType),
                  PaxField(ctrl: ctrl),
                  if (destCountry.value == "1")
                    CheckboxField(
                      fontSize: 12,
                      fontWeight: FontWeight.bold,
                      label: "  Galapagos Cruise?",
                      color: Colors.black,
                      ...
                      iconSize: 20,
                      onSaved: (value) {
                        setFormValue(globalctx.memory, "tour",
                            "galapagos_cruise", value);
                        setFormValue(
