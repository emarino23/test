...
///                               country.value = value!;
///                                procCityData(
///                                    countries[countrylist[parseInt(value)]
///                                        ["description"]]);
///                                log("CHANGED: ");
///                              },
/// ```
...
///### Uses:
/// ```dart
///     var days = parseInt(getFormValue(
...
saveMultiDropDown(setters, catalog, values, limit) {
  try {
    if (values.length <= limit && !values.contain(0)) {
      var mem = <String>[];
